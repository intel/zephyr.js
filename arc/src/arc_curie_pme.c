...
void curie_pme_configure(u16_t global_context, PME_DISTANCE_MODE distance_mode,
...
u16_t curie_pme_learn(u8_t *pattern_vector, s32_t vector_length,
                      u16_t category)
{
    ...
    reg_write16(CAT, (reg_read16(CAT) & ~CAT_CATEGORY) |
