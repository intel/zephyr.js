...
if check_for_require spi || check_config_file ZJS_SPI; then
    echo "CONFIG_SPI=y" >> $PRJFILE
    echo "CONFIG_SPI_0=y" >> $PRJFILE
    echo "CONFIG_SPI_0_NAME=\"SPI_0\"" >> $PRJFILE
    echo "CONFIG_SPI_0_IRQ_PRI=2" >> $PRJFILE
    echo "CONFIG_SPI_0_DEFAULT_CFG=0x80" >> $PRJFILE
    echo "SPI_0_DEFAULT_BAUD_RATE=500000" >> $PRJFILE
    echo "CONFIG_SPI_1=y" >> $PRJFILE
    echo "CONFIG_SPI_1_NAME=\"SPI_1\"" >> $PRJFILE
    echo "CONFIG_SPI_1_IRQ_PRI=2" >> $PRJFILE
    echo "CONFIG_SPI_1_DEFAULT_CFG=0x80" >> $PRJFILE
    echo "SPI_1_DEFAULT_BAUD_RATE=500000" >> $PRJFILE
    MODULES+=" -DBUILD_MODULE_SPI"
    echo "export ZJS_SPI=y" >> $CONFFILE
    buffer=true;
fi
