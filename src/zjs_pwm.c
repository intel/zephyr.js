...
static bool zjs_set_period(jerry_api_object_t *obj, uint32_t period)
{
...
static bool zjs_set_pulse_width(jerry_api_object_t *obj, uint32_t pulseWidth)
{
                                 ...
                                 const jerry_api_length_t args_cnt)
{
    ...
    uint32_t pulseWidth = (uint32_t)jerry_api_get_number_value(&args_p[0]);
