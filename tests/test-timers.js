...
var testIntervalMoreArg = setInterval(function (arg1, arg2) {
    ...
    if (countMoreArg == countFlag) {
        assert((arg1 === IntervalArg1 + 1) && (arg2 === IntervalArg2), "setInterval: set delay and optional arg");
        clearInterval(testIntervalMoreArg);
    }
}, 100, IntervalArg1, IntervalArg2);

expectThrow("clearInterval: not existed intervalID", function () {
    clearInterval(NotExistedInterval);
});
...
expectThrow("clearTimeout: not existed timeoutID", function () {
