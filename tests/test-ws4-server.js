...
// Run this test case and run ws client on linux by /tools/test-ws4-client.js
// If on a101 with ENC28J60 ethernet board or on K64f:
//     Add soft router on linux:
//         ip -4 route add 192.0.2/24 dev eno1
//     Add IPv4 addr on linux:
//         ip -4 addr add 192.0.2.2/24 dev eno1

console.log("Test web socket server APIs about IPv4");
